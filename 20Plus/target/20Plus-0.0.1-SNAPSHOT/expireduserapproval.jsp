...
<nav class="navbar navbar-inverse" style="background-color:#1E90FF;">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="admin.jsp"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
    </ul>
  </div>
</nav>
<%
...
<%          
    ...
    <form action="ExpiredUserUpdateController" method="post">
            ...
            <table class="table table-borderless">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="text1" id="admin_name2"
                            name="user_name_row1" required></td>
                        <td><input class="form-control" type="text4" id="admin_address2"
                            name="user_address_row1" onkeypress="checkNum1()"  min="0"
                            max="9999999999" maxlength="10" required></td>
                        <td><input class="form-control" type="text5" id="admin_pincode2"
                            name="user_pincode_row1" onkeypress="checkNum3()" min="0" max="999999"
                            maxlength="6" required></td>
                        <td><input class="form-control" type="text6" id="admin_mobile_no2"
                            name="user_mobile_no_row1" onkeypress="checkNum1()" min="0"
                            max="9999999999" maxlength="10" required></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="text1" id="admin_name3"
                            name="user_name_row2" required></td>
                        <td><input class="form-control" type="text4" id="admin_address3"
                            name="user_address_row2" required></td>
                        <td><input class="form-control" type="text5"  id="admin_pincode3"
                            name="user_pincode_row2" onkeypress="checkNum3()" min="0" max="999999"
                            maxlength="6" required></td>
                        <td><input class="form-control" type="text6" id="admin_mobile_no3"
                            name="user_mobile_no_row2" onkeypress="checkNum1()" min="0"
                            max="9999999999" maxlength="10" required></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td><input class="form-control" type="text1" id="position4"
                            name="name13" value="${current_user.userName}" required></td>
                        <td><input class="form-control" type="text4" id="position4"
                            name="name14" value="${current_user.address}" required></td>
                        <td><input class="form-control" type="text5" id="position4"
                            name="name15" onkeypress="checkNum3()" min="0" max="999999"
                            maxlength="6" value="${current_user.pincode}" required></td>
                        <td><input class="form-control" type="text6" id="position4"
