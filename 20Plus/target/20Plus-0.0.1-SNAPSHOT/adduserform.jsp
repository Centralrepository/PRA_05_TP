...
<nav class="navbar navbar-inverse" style="background-color:#1E90FF;">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="#" style="color:white"><span class="glyphicon glyphicon-user"></span> <span>${admin_name}</span></a></li>
...
<h1 style="margin-left: 600px;color:black;margin-top:2px;font-family:serif">Add New User</h1>
<br/>

<div id="hid" style="margin-left:90px; margin-top:-60px">
<div class="wrapper">
<form class="login" action="addMember" style="margin-top:5px;" method="post">
