...
<center>
		...
		<%try{
			if(request.getParameter("login_msg")!=null){
				%>
				<span style="float:left;position: absoute"><%out.print(request.getParameter("login_msg"));%></span>
				<%
			}
		 }catch(Exception e){
		...
		<h1 class="text-center">Forgot Password?</h1><br/>
		    <form class="login-form" action="forgotpasswordadmincontroller.jsp" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1" style="float:left;font-size:20px;font-weight:300" >User Id</label>
    <input type="text" class="form-control" style="width:56%;margin-left:21px" name="adminId" placeholder=""
